...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@/views/components/ui/sheet';
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        'relative flex w-full flex-1 flex-col bg-white dark:bg-gray-950',
