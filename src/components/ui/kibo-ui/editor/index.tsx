...
const EditorSlashMenu = ({ items, editor, range }: EditorSlashMenuProps) => (
  ...
  >
    <CommandEmpty className="flex w-full items-center justify-center p-4 text-gray-500 text-sm dark:text-gray-400">
      <p>No results</p>
    </CommandEmpty>
    <CommandList>
      {items.map((item) => (
        ...
        >
          <div className="flex size-9 shrink-0 items-center justify-center rounded border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-gray-800">
  ...
  const defaultExtensions = [
    StarterKit.configure({
      ...
      code: {
        HTMLAttributes: {
          class: cn(
            'rounded-md bg-gray-100 px-1.5 py-1 font-medium font-mono dark:bg-gray-800'
          ),
          spellcheck: 'false',
        },
      },
      horizontalRule: {
        HTMLAttributes: {
          class: cn('mt-4 mb-6 border-gray-500 border-t dark:border-gray-400'),
        },
      },
      dropcursor: {
        color: 'var(--border)',
    ...
    Placeholder.configure({
      placeholder,
      emptyEditorClass:
        'before:text-gray-500 before:content-[attr(data-placeholder)] before:float-left before:h-0 before:pointer-events-none dark:before:text-gray-400',
    }),
    ...
    CodeBlockLowlight.configure({
      ...
      HTMLAttributes: {
        class: cn(
          'rounded-md border border-gray-200 p-4 text-sm dark:border-gray-800',
    ...
    TableRow.configure({
      HTMLAttributes: {
        class: cn(
          'relative box-border min-w-[1em] border border-gray-200 p-1 text-start align-top dark:border-gray-800'
        ),
      },
    }),
    TableCell.configure({
    ...
    TableHeader.configure({
      HTMLAttributes: {
        class: cn(
          'relative box-border min-w-[1em] border border-gray-200 bg-gray-100 p-1 text-start align-top font-medium font-semibold text-muted-foreground dark:border-gray-800 dark:bg-gray-800'
        ),
      },
    }),
    TaskList.configure({
...
export const EditorBubbleMenu = ({
  ...
  <BubbleMenu
    className={cn(
      'flex rounded-xl border border-gray-200 bg-white p-0.5 shadow dark:border-gray-800 dark:bg-gray-950',
      ...
      <PopoverContent align="start" className="w-60 p-0" sideOffset={10}>
        <form onSubmit={handleSubmit} className="flex p-1">
          <input
            ...
            className="flex-1 bg-white p-1 text-sm outline-none dark:bg-gray-950"
          ...
          {editor.getAttributes('link').href ? (
            <Button
              ...
              variant="outline"
              type="button"
              className="flex h-8 items-center rounded-sm p-1 text-red-500 transition-all hover:bg-gray-50 dark:hover:bg-red-500 dark:text-red-900 dark:hover:bg-gray-50 dark:dark:hover:bg-red-900"
              onClick={() => {
                // @ts-expect-error "TipTap extensions are not typed"
...
export const EditorTableGlobalMenu = ({
  ...
  return (
    <div
      className={cn(
        '-translate-x-1/2 absolute flex translate-y-1/2 items-center rounded-full border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-950',
        {
          hidden: !left && !top,
        }
      )}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        asChild
        className={cn(
          '-translate-x-1/2 -translate-y-1/2 absolute flex h-4 w-7 overflow-hidden rounded-md border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-950',
          {
            hidden: !left && !top,
          }
        )}
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="icon"
          className={cn(
            '-translate-x-1/2 -translate-y-1/2 absolute flex h-7 w-4 overflow-hidden rounded-md border border-gray-200 bg-white shadow-xl dark:border-gray-800 dark:bg-gray-950',
            {
              hidden: !left && !top,
            }
          )}
...
export const EditorTableColumnBefore = () => {
  ...
  return (
    ...
    >
      <ArrowLeftIcon size={16} className="text-gray-500 dark:text-gray-400" />
...
export const EditorTableColumnAfter = () => {
  ...
  return (
    ...
    >
      <ArrowRightIcon size={16} className="text-gray-500 dark:text-gray-400" />
...
export const EditorTableRowBefore = () => {
  ...
  return (
    ...
    >
      <ArrowUpIcon size={16} className="text-gray-500 dark:text-gray-400" />
...
export const EditorTableColumnDelete = () => {
  ...
  return (
    ...
    >
      <TrashIcon size={16} className="text-red-500 dark:text-red-900" />
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          <ColumnsIcon size={16} className="text-gray-500 dark:text-gray-400" />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          <RowsIcon size={16} className="text-gray-500 dark:text-gray-400" />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        ...
        >
          <BoltIcon size={16} className="text-gray-500 dark:text-gray-400" />
        </Button>
      </TooltipTrigger>
      <TooltipContent>
        <span>Fix table</span>
...
export const EditorCharacterCount = {
  Characters({ children, className }: EditorCharacterCountProps) {
    ...
    return (
      <div
        className={cn(
          'absolute right-4 bottom-4 rounded-md border border-gray-200 bg-white p-2 text-gray-500 text-sm shadow dark:border-gray-800 dark:bg-gray-950 dark:text-gray-400',
          className
        )}
      >
        {children}
